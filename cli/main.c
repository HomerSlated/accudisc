...
static void usage(FILE *to)
{
    fprintf(to,
        ...
        "                 (default 0 = off, max 8). A mismatch re-reads\n"
        "                 BOTH chunks at that seam and checks every sector;\n"
        "                 a slip that never reaches a seam is not seen —\n"
        "                 only --verify 2 checks every sector\n"
